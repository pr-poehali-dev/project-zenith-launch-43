...
const products = [
  ...
  {
    id: 19,
    name: "Комплект парикмахерский «Браун» 2 кресла + мойка",
    price: 89000,
    category: "Парикмахерское оборудование",
    description: "Готовый комплект для парикмахерской: два рабочих кресла с гидроподъёмником и мойка с мягким креслом. Коричневая экокожа, хромированные основания — всё в едином стиле.",
    features: ["2 кресла + мойка", "Коричневая экокожа", "Гидроподъёмник", "Хромированные основания"],
    image: "https://cdn.poehali.dev/projects/58c01076-b127-47f5-8f9e-62ad921f3ee7/bucket/c873bc20-f9fb-4109-a2ab-22587a049ebe.jpg",
    badge: "Комплект",
  },
  {
    id: 20,
    name: "Мойка парикмахерская «Браун» с креслом",
    price: 38500,
    category: "Парикмахерское оборудование",
    description: "Парикмахерская мойка с удобным мягким креслом из коричневой экокожи. Чёрная керамическая чаша, плавные формы, комфорт для клиента.",
    features: ["Чёрная керамическая чаша", "Мягкое кресло", "Коричневая экокожа", "Стильный дизайн"],
    image: "https://cdn.poehali.dev/projects/58c01076-b127-47f5-8f9e-62ad921f3ee7/bucket/cc7df08f-031c-4426-bd92-7e3b302ef723.jpg",
    badge: "",
  },
  {
    id: 21,
    name: "Зеркало настольное с LED-подсветкой, золото",
    price: 7900,
    category: "Оборудование",
    description: "Круглое настольное зеркало с тёплой LED-подсветкой по контуру и сенсорным управлением. Золотая рама на устойчивой подставке — украсит любое рабочее место.",
    features: ["LED-подсветка", "Сенсорное управление", "Золотая рама", "Устойчивая подставка"],
    image: "https://cdn.poehali.dev/projects/58c01076-b127-47f5-8f9e-62ad921f3ee7/bucket/0b26627b-5bbb-4eae-a66a-dd02f0293d92.jpg",
    badge: "",
  },
  {
    id: 22,
    name: "Зеркало круглое настенное LED «Люкс»",
    price: 12500,
    category: "Оборудование",
    description: "Большое круглое зеркало с яркой LED-подсветкой и золотой рамой. Сенсорная кнопка включения, равномерный свет — идеально для рабочего места стилиста.",
    features: ["Яркая LED-подсветка", "Золотая рама", "Сенсорное включение", "Равномерный свет"],
    image: "https://cdn.poehali.dev/projects/58c01076-b127-47f5-8f9e-62ad921f3ee7/bucket/17aa9af5-4562-4a4a-9702-4a434b91dcc8.jpg",
    badge: "Новинка",
  },
]
